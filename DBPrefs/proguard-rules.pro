...
#Keep any config keys user creates for future use, so proguard does not strip or obfuscate them
-keep,includedescriptorclasses class * implements info.dbprefs.lib.ConfigKey
